...
class ContextTranslationDataset(Dataset):
    ...
    def __init__(self, path: str, exts, fields, **kwargs) -> None:
        ...
        with io.open(src_path, mode='r', encoding='utf-8') as src_file, \
            ...
            prev_src_line, prev_trg_line, prev_prev_src_line, prev_prev_trg_line = CONTEXT_TOKEN + CONTEXT_EOS_TOKEN, CONTEXT_TOKEN + CONTEXT_EOS_TOKEN, CONTEXT_TOKEN + CONTEXT_EOS_TOKEN, CONTEXT_TOKEN + CONTEXT_EOS_TOKEN
